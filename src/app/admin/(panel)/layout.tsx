    ...
    return (
        <div className="min-h-screen bg-dark-bg flex">
            ...
            <div className="flex-1 flex flex-col min-h-screen relative">
                {/* Mobile Header */}
                <header className="md:hidden h-16 border-b border-dark-border flex items-center justify-between px-4 bg-dark-200 sticky top-0 z-30">
                    <button
                    ...
                    {isMobileMenuOpen && (
                        ...
                        >
                            <motion.div
                                ...
                                className="w-72 h-full bg-dark-200 border-r border-dark-border shadow-2xl"
