...
export default function LeGeZtAdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-dark-bg flex font-sans text-gray-100">
            ...
            <div className={`flex-1 flex flex-col min-h-screen relative transition-all duration-300 ease-in-out ${isCollapsed ? 'ml-20' : 'ml-64'}`}>
                ...
                {/* Admin Header */}
                <header className="h-16 bg-dark-200/80 backdrop-blur-md border-b border-dark-border flex items-center justify-between px-8 sticky top-0 z-30 shadow-lg">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right hidden sm:block">
                            ...
                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Super Admin</div>
                        </div>
